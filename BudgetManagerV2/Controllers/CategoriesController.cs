...
namespace BudgetManagerV2.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        {
            ViewBag.Cat_ID = new SelectList(db.Category, "Id", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Cat_ID")] Category category)
        {
            ...
            ViewBag.Cat_ID = new SelectList(db.Category, "Id", "Name", category.Cat_ID);
            return View(category);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Cat_ID")] Category category)
        {
            if (ModelState.IsValid)
            {
